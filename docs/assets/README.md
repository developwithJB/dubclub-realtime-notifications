# Screenshot placeholders for README and demo framing
...
- `docs/assets/fan-delivery-view.png`
  - Simulated fan cards with at least one fan highlighted as newly notified and one fan offline/ignored
  - Shows targeted delivery behavior

- `docs/assets/latency-metrics.png`
  - Metrics panel and live event stream
  - Highlight average and p95 values updating after an event

- `docs/assets/load-test-output.png`
  - Terminal output from `npm run load:test:small`
